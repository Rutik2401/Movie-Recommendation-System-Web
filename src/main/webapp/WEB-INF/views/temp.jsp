...
<body>
	...
	<div class="wrapper ">
		...
		<div
			class="Sub-Conatiner  position-absolute top-0 d-flex flex-column justify-content-center gap-5">
			<!-- Navbar -->
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav gap-4">
							...
							<div
								...
								<a type="button" href="register.html"
									class="btn btn-outline-primary text-bg-dark">Register</a> <a
									type="button" href="asset/signin.html" class="btn btn-danger">Sign
									in</a>
							</div>
						</ul>
					</div>
				...
				<div class="AllMovies d-flex justify-content-center">
					<div class="movie d-flex gap-3 flex-column">
						<a href="details.html"> <img
							src="<c:url value='/resources/Images/image.png' />"
		...
		<div
			...
			<div class="links text-dark">
				<a href="#" class="text-decoration-none text-dark">Privacy
					Policy</a> <a href="#" class="text-decoration-none text-dark">Terms
					& Conditions</a> <a href="#" class="text-decoration-none text-dark">Cookies</a>
				<a href="#" class="text-decoration-none text-dark">Help</a> <a
					href="#" class="text-decoration-none text-dark">About Us</a> <a
					href="#" class="text-decoration-none text-dark">FAQ</a> <a href="#"
					class="text-decoration-none text-dark">Become Our Partner</a>
			</div>
			<div class="by">
