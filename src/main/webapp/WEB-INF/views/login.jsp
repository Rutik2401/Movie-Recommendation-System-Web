...
<body>
	...
	<div
		...
		<!-- ${pageContext.request.contextPath}/auth -->
		<form name="frm" action="auth" method="post">
			<div
				class="sign-section  d-flex gap-4 flex-column align-items-center justify-content-center">
				...
				<div class="forgat">
					...
					<a href="#" class="text-decoration-none text-white fw-medium">Forgot
						password?</a>
				</div>


				<div class="ref-register d-flex gap-3 text-white">
					<p class="">New to MRC</p>
					<a href="reg"
						cestlass="Sign-up-now text-white text-decoration-none fw-bold">Register
						Now.</a>
				</div>
			</div>
		</form>
